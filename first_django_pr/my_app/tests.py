...
class DatabaseTestCase(TestCase):
    def setUp(self):
        ...
        self.note1 = Note.objects.create(week_day=self.day1, title='Note1', msg='Message1')
        self.note2 = Note.objects.create(week_day=self.day2, title='Note2', msg='Message2')
        self.note3 = Note.objects.create(week_day=self.day2, title='Note3', msg='Message3')
        self.note4 = Note.objects.create(week_day=self.day2, title='Note4', msg='Message4')
